...
namespace YouTube_Search_and_Downloader
{
    static class Program
    {
        ...
        static void Main()
        {
            AppDomain.CurrentDomain.AssemblyResolve += (sender, arg) => { if (arg.Name.StartsWith("WrapYoutubeDl")) return Assembly.Load(Properties.Resources.WrapYoutubeDl); return null; };
